...
public class mainController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            } else if(action.equals("manageSnacks")){
                url = "manageSnacksServlet";
            ...
            } else if(action.equals("FinishCreateNewAccount")){
                url = "loginServlet";
            } else if(action.equals("updateSnacks")){
                url = "updateSnacksServlet";
            } else if(action.equals("addSnack")){
                url = "addSnackServlet";
